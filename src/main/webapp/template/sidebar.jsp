     ...
     <input hidden name="page" value="1">
         <div class="form-group column"">
             <div class="col-sm-12 mt-5">
                 ...
                 <input name="test-name" type="text" value="${requestScope.testName}" class="form-control" placeholder="Search by test name...">
             </div>
             <div class="col-sm-12 mt-2">
                 <label class="form-label" for="test-subject">Test subject</label>
                 <input name="test-subject" value="${requestScope.testSubject}"type="text" id="test" class="form-control" placeholder="Search by test subject...">
             </div>
             <div class="col-sm-12 mt-2">
                 <label class="form-label" for="test-level">Test level</label>
                 <select name="test-level" value="${requestScope.testLevel}" class="form-select form-select-md mb-3" aria-label=".form-select-lg example">
             ...
             <select name="test-sort" value="${requestScope.testSort}" class="form-select" size="5" multiple aria-label="multiple select example">
             ...
             <div class="col-sm-12 mt-2">
                 ...
                 <c:choose>
                      <c:when test="${requestScope.testOrder} == '1'}">
                        ...
                        <c:otherwise>
                                <input value="1" type="radio" class="btn-check" name="test-order" id="1primary-outlined" autocomplete="off">
                               <label id="label-radio" class="btn btn-outline-success col-6" for="1primary-outlined">ASC</label>
                               <input value="0" type="radio" class="btn-check" name="test-order" id="primary-outlined" autocomplete="off" checked>
                               <label id="label-radio" class="btn btn-outline-success col-6" for="primary-outlined">DESC</label>
                        </c:otherwise>
                  </c:choose>
                     <input value="1" type="radio" class="btn-check" name="test-order" id="1primary-outlined" autocomplete="off" checked>
