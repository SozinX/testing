...
<nav id="navigation" class="navbar navbar-expand-lg navbar-light ">
    ...
    <div class="collapse navbar-collapse ml-5" id="navbarNav">
         <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/mytests?page=1"><fmt:message key="MyTests" /></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/create" ><fmt:message key="CreateTest" /></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/block" ><fmt:message key="Block" /></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/unblock" ><fmt:message key="Unblock" /></a>
            </li>
          ...
          <div class="collapse navbar-collapse ml-5" id="navbarNav">
                      <ul class="navbar-nav ml-auto">
                             <li class="nav-item dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-down dropdown-cyan">
                                      <a class="nav-link" href="/settings"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
                                                                   ...
                                                                   </svg> <fmt:message key="Settings" /></a>
